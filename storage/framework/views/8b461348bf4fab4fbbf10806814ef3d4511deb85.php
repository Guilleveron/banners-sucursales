...
<?php if (! $__env->hasRenderedOnce('0f72d1b7-caba-444a-af31-b564aab9ddd5')): $__env->markAsRenderedOnce('0f72d1b7-caba-444a-af31-b564aab9ddd5'); ?>
...
<?php $component->withAttributes(['wire:model' => 'confirmingPassword']); ?>
         ...
         <?php $__env->slot('content', null, []); ?> 
            ...
            <div class="mt-4" x-data="{}"
                ...
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'jetstream::components.input','data' => ['type' => 'password','class' => 'mt-1 block w-3/4 px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white caret-red-500 focus:border-red-600 focus:ring-offset-2 focus:ring focus:ring-red-300 focus:shadow-red-500 focus:outline-none','placeholder' => ''.e(__('Contraseña')).'','xRef' => 'confirmable_password','wire:model.defer' => 'confirmablePassword','wire:keydown.enter' => 'confirmPassword']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /Users/ayg/Documents/Personales/proyectos/banners-sucursales/resources/views/vendor/jetstream/components/confirms-password.blade.php ENDPATH**/ ?>