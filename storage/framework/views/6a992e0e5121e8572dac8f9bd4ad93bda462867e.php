                        ...
                        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-200 w-full">
                                ...
                                <tr class="border-b">
                                    ...
                                    <td class="px-6 py-3 whitespace-nowrap bg-white divide-y divide-gray-200">
                                        <img src="<?php echo e(env('APP_URL') . Storage::url($banner->image)); ?>"
                                            id="imageSelected" style="max-height: 250px;">
                                    </td>
                                </tr>
                            </table>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\banners-sucursales\resources\views/banners/show.blade.php ENDPATH**/ ?>