                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <div class="text-sm text-gray-600">
                                {{ $session->agent->platform() ? $session->agent->platform() : 'Desconocida' }} -
                                {{ $session->agent->browser() ? $session->agent->browser() : 'Desconocida' }}
                            </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                ...
                <div class="mt-4" x-data="{}"
                    ...
                    <x-jet-input type="password" class="mt-1 block w-3/4 px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white caret-red-500 focus:border-red-600 focus:ring-offset-2 focus:ring focus:ring-red-300 focus:shadow-red-500 focus:outline-none" placeholder="{{ __('Password') }}"
