                                    ...
                                    @foreach ($banners as $banner)
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                <span class="font-bold sm:font-normal">{{ $banner->title }}</span>
                                            ...
                                            <td
                                                ...
                                                <a href="{{ url('categories' . '/' . $banner->category->id) }}">
                                                    <span
                                            ...
                                            <td class="px-4 py-1 sm:px-2 sm:py-2 table-cell text-sm font-medium">
                                                ...
                                                <a href="{{ route('banners.edit', $banner->id) }}"> <span
